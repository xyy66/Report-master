	...
	<div class="formbody">
		...
		<ul class="forminfo">
			...
			<li>
				...
				<label><input type="radio" name="message.ispublish" value="1" #if($!modifyMessageForm.message.ispublish==1) checked="checked" #end/>立即发布&nbsp;</label>
				<label><input type="radio" name="message.ispublish" value="0" #if($!modifyMessageForm.message.ispublish==0) checked="checked" #end/>暂不发布</label>
			</li>
			<li>
				<label>发布时间：</label>
