...
jQuery(function () {
     jQuery("input[name='link.title']").focus();
...
<div class="main">
	...
	<div class="form">
		<form method='post' id="form_do" name="form_do" action="$link.setAction('modifyLink')">
		<dl>
			<dt> 网站名称：</dt>
			<dd>
				<input type="text" name="link.name" class="inp_large" value="$!modifyLinkForm.link.name"/>
		...
		<dl>
			<dt> 网站地址：</dt>
			<dd>
				<input type="text" name="link.url" class="inp_large" value="$!modifyLinkForm.link.url" />
				<span style="color: red;">*</span>
			</dd>
		</dl>
		<dl>
			<dt> 排序：</dt>
			<dd>
				<input type="text" name="link.sort" class="inp_small" value="$!modifyLinkForm.link.sort" />
			</dd>
		</dl>
		<dl>
			<dt> 网站简况：</dt>
			<dd>
				<textarea name="link.description" class="tarea_default">$!modifyLinkForm.link.description</textarea>
			</dd>
		</dl>
		<dl>
		...
		<div class="form_b">		
			<input type="hidden" name="link.id" value="$!modifyLinkForm.link.id" />
