...
<body>
<div class="main">
    <div class="pos">网站介绍</div>
	<div class="form">
		<form method='post' id="form_do" name="form_do" action="$link.setAction('modifyWebAbout')">
		<dl>
			<dt> 摘要：</dt>
			<dd>
				<textarea name="about.description" id="description" class="tarea_default">$!aboutForm.about.description</textarea>
