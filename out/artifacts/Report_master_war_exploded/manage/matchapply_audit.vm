...
<div class="main">
	...
	<div class="formbody">
		...
		<form method='post' id="form_do" name="form_do" action="$link.setAction('auditMatchapply')">
		<ul class="forminfo">
			<li>
				<label>参赛年度：</label>
			...
			<li>
				...
				<select name="matchapply.state" class="dfinput" style="width:200px;">
			...
			<li>
				<label>审核意见：</label>
				<label style="margin-bottom: 13px;"><textarea name="matchapply.checkmemo" class="dfinput" style="width:600px;height:100px;"></textarea></label>
			</li>
        </ul>
		<ul class="forminfo">
			<li>
				<input type="hidden" name="matchapply.id" value="$!matchapply.id" />
