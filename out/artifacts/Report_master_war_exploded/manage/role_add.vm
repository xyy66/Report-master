...
<div class="main">
	<div class="place">
        ...
        <ul class="placeul">
            ...
            <li><a href="#">添加用户类型</a></li>
        </ul>
    </div>
	<div class="formbody">
		<form method='post' id="form_do" name="form_do" action="$link.setAction('addRole')">
		<ul class="forminfo">
            <li>
				<label>用户类型名称：<b>*</b></label>
				<input type="text" name="role.name" class="dfinput" style="width:300px;" value="$!addRoleForm.role.name"/>
			</li>
			<li>
				<label>用户类型描述：</label>
				<label><textarea name="role.description" class="dfinput" style="width:600px;height:100px;">$!addRoleForm.role.description</textarea></label>
			</li>
			<li>
